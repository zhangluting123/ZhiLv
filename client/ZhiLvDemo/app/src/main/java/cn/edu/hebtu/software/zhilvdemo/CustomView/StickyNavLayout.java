package cn.edu.hebtu.software.zhilvdemo.CustomView;
...
/**
 * @ProjectName:    ZhiLv
 * @Description:    屏幕向上滑动中间tab置顶，显示下一界面
 * @Author:         张璐婷
 * @CreateDate:     2020/12/14$ 15:13$
 * @Version:        1.0
 */
public class StickyNavLayout extends LinearLayout implements NestedScrollingParent
{
    ...
    private void animateScroll(float velocityY, final int duration,boolean consumed) {
        ...
        if (mOffsetAnimator == null) {
            ...
            mOffsetAnimator.setInterpolator((TimeInterpolator) mInterpolator);
    ...
    protected void onFinishInflate()
    {
        ...
        mTop = findViewById(R.id.mine_topview);
        mNav = findViewById(R.id.pager_tabs);
        View view = findViewById(R.id.pager_viewpager);
    ...
    {
        //不限制顶部的高度
        super.onMeasure(widthMeasureSpec, heightMeasureSpec + 760);
        getChildAt(0).measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
        ViewGroup.LayoutParams params = mViewPager.getLayoutParams();
        params.height = getMeasuredHeight() - mNav.getMeasuredHeight();
        setMeasuredDimension(getMeasuredWidth(), mTop.getMeasuredHeight() + mNav.getMeasuredHeight() + 760);
